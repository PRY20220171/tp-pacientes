...
public class Paciente implements Serializable {
    ...
    @ApiModelProperty(value = "Es la fecha de nacimiento del paciente", dataType = "date", position = 13)
    ...
    @ApiModelProperty(value = "ID del domicilio del paciente", dataType = "uuid", position = 15)
    ...
    @ApiModelProperty(value = "ID del antecedente perinatal del paciente", dataType = "uuid", position = 17)
    ...
    @ApiModelProperty(value = "ID del antecedente psicológico del paciente", dataType = "uuid", position = 18)
    @Column("idantecedentepsico")
    @CassandraType(type = CassandraType.Name.UUID)
    private UUID idantecedentepsico;
    @Transient
    private AntecedentePsicologico antecedentepsico;

    @ApiModelProperty(value = "ID del antecedente familiar del paciente", dataType = "uuid", position = 19)
